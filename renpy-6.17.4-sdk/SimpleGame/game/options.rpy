...
init -1 python hide:
    ...
    config.window_title = u"SimpleGame"
    ...
    style.default.font = "tl/None/gbfont.ttf"
...
python early:
    config.save_directory = "SimpleGame-1398514272"
...
init python:
    ...
    build.directory_name = "SimpleGame-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "SimpleGame"
